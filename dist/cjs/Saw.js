...
class Saw {
    constructor(object) {
        ...
        else if (object instanceof Matches_1.default) {
    ...
    match(match) {
        ...
        matchArray.some((m) => {
            ...
            if (!matches) {
                ...
                saw._context = new Matches_1.default(matches, m);
                return true;
            }
            return false;
        });
    ...
    item(index) {
        const saw = new Saw(this._context);
        if (saw._context instanceof Matches_1.default) {
    ...
    itemFromRight(index) {
        ...
        if (saw._context instanceof Matches_1.default || Array.isArray(saw._context)) {
    ...
    reverse() {
        ...
        else if (saw._context instanceof Matches_1.default) {
            const array = saw.toArray();
            if (array.length === 1) {
    ...
    toArray() {
        ...
        else if (this._context instanceof Matches_1.default) {
    ...
    _contextToString(context) {
        ...
        else if (context instanceof Matches_1.default) {
